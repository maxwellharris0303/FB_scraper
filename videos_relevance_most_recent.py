...
search_word = "fence"
most_recent_search = True

driver = login_module.fb_login()

csv_file_name = "output_videos_relevance_most_recent.csv"
...
if most_recent_search:
    url = f"https://www.facebook.com/search/videos?q={search_word}&filters=eyJ2aWRlb3Nfc29ydF9ieTowIjoie1wibmFtZVwiOlwidmlkZW9zX3NvcnRfYnlcIixcImFyZ3NcIjpcIk1vc3QgUmVjZW50XCJ9In0%3D"
else:
    url = f"https://www.facebook.com/search/videos?q={search_word}"
driver.get(url)
sleep(5)
