...
csv_file_name = "output_recent_post.csv"
...
url = f"https://www.facebook.com/search/posts?q={search_word}&filters=eyJyZWNlbnRfcG9zdHM6MCI6IntcIm5hbWVcIjpcInJlY2VudF9wb3N0c1wiLFwiYXJnc1wiOlwiXCJ9In0%3D"
driver.get(url)
sleep(5)
